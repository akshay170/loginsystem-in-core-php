...
<input class="form-control" id="email" name="email" type="email" placeholder="akshay@gmail.com" required />
...
<div class="col-md-6">
 <div class="form-floating mb-3 mb-md-0">
<input class="form-control" id="password" name="password" type="password" placeholder="Create a password" pattern="({4,})" title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required/>
...
<div class="col-md-6">
<div class="form-floating mb-3 mb-md-0">
<input class="form-control" id="confirmpassword" name="confirmpassword" type="password" placeholder="Confirm password" pattern="({4,})" title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required />
...
<div class="d-grid"><button type="submit" class="btn btn-primary btn-block" name="submit">Create Account</button></div>
 ...
 <div class="small"><a href="/loginsystem/login">Have an account? Go to login</a></div>
  <div class="small"><a href="/loginsystem/">Back to Home</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
