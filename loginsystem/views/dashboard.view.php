                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        ...
                        // die;
                            ...
                            // echo rowCount($db,"select id from users");
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Registered Users
                                        <span style="font-size:22px;"> <?php echo rowCount($db,"select id from users"); ?></span>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="/loginsystem/admin_manage-users">View Details</a>
